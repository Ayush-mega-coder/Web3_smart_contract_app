...
const App = () => {
  ...
  const getAllWaves = async () => {
    try {
      ...
      if (ethereum) {
        ...
        //we onlu need address, timestamp and message in out UI so lets pick those out
        let wavesCleaned = [];
        waves.forEach(wave => {
          wavesCleaned.push({
            address: wave.waver,
  ...
  const contractAddress = "0xB4C8De359Bc3123af00f035b8170Bc8dc0Df1798"
    ...
    <>
      <div className="mainContainer" >
        ...
        <div className="dataContainer" >
          ...
          <div className="bio">
            I am Ayush Purohit and welcome to my DOM! Connect your Ethereum wallet and wave at me!
        </div>
          <br />
